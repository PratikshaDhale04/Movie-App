...
('Spider-Man: No Way Home', 'Action', 'With Spider-Man identity now revealed, Peter asks Doctor Strange for help. When a spell goes wrong, dangerous criminals from other universes are accidentally released.', 2021, 8.2, 'https://images.unsplash.com/photo-1635805737707-575885ab0820?w=400', 'https://www.youtube.com/watch?v=JfVOs4VSpmA', 'https://www.youtube.com/embed/JfVOs4VSpmA', '2h 28min', 'Jon Watts', 'Tom Holland, Zendaya, Benedict Cumberbatch', 4500000); 
